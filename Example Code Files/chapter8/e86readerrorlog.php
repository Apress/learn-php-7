...
echo "<link href='e23ajaxdemo.css' rel='stylesheet'>";
...
echo "</table>";
echo "</div><div id='footer'>Copyright &copy; 2015 Little Ocean Waves Publishing - Steve Prettyman</div></div>";
echo "</body></html>";
}
...
echo "<html><head><title>ABC Canine Shelter Reservation System</title>";
echo "<link href='e23ajaxdemo.css' rel='stylesheet'><style type='text/css'>img { height: 100px; width: 140px; }</style></head><body>";
