...
echo "<p>";
echo "<a href='e74login.php'>Login</a> | <a href='e73register.php'>Create an account</a>";
echo "</p>";
}
else
{
...
<div id="JS">
<form method="post" action="e65dog_interface.php" onSubmit="return validate_input(this)">
