...
{ 		
		echo "<td><a href='e64readchangelog.php?rn=$J&change_File=$change_File'>Delete</a></td>";
...
echo "<form id='file_select' name='file_select' method='post' action='e64readchangelog.php'>";
